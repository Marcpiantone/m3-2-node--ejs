...
const q6 = (req, res) => res.render("pages/question6", { questionNumber: 6 });
const q7 = (req, res) => res.render("pages/question7", { questionNumber: 7 });
const q8 = (req, res) => res.render("pages/question8", { questionNumber: 8 });
const q9 = (req, res) => res.render("pages/question9", { questionNumber: 9 });
const q10 = (req, res) =>
  res.render("pages/question10", { questionNumber: 10 });
